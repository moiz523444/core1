...
export const SERVICES_DATA = [
  {
    ...
    icon: <Smartphone />,
    desc: 'Building high-performance, secure, and scalable mobile apps for iOS and Android.',
  ...
  },
  {
    ...
    icon: <Globe />,
    desc: 'Crafting robust and dynamic web applications that deliver seamless user experiences and scale easily.',
  ...
  },
  {
    ...
    title: 'SEO Services',
    icon: <Search />,
    desc: 'Improving your search engine rankings to increase organic traffic and generate higher-quality leads.',
  ...
  },
  {
    ...
    icon: <Settings />,
    desc: 'Tailored content management systems designed so you can easily update and manage your website.',
  ...
  },
  {
    ...
    icon: <ShoppingBag />,
    desc: 'Developing high-conversion online stores with seamless checkout flows and reliable performance.',
  ...
  },
  {
    ...
    icon: <Shield />,
    desc: 'Protecting your business data and infrastructure with enterprise-grade security solutions.',
  ...
  },
  {
    ...
    icon: <Box />,
    desc: 'Engineering scalable, cloud-based software platforms designed for recurring revenue models.',
  ...
  },
  {
    ...
    icon: <Cloud />,
    desc: 'Managing reliable cloud infrastructure and IT ecosystems to keep your business running smoothly.',
